...
})({"8enHp":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ce6f266e2804e170";
"use strict";
...
},{}],"6QZzX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _heartRedPng = require("../img/heart_red.png");
var _heartRedPngDefault = parcelHelpers.interopDefault(_heartRedPng);
var _heartPng = require("../img/heart.png");
...
function render(data) {
    ...
    for(let i = 1; i < 20; i++){
        if (data.meals[0][`strIngredient${i}`] == "" || data.meals[0][`strIngredient${i}`] == null) break;
        else {
...
function addToShopList(data) {
    ...
    while(shopList.firstChild)shopList.removeChild(shopList.firstChild);
...
},{"../img/heart_red.png":"jcqB2","../img/heart.png":"gQQF6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jcqB2":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("hIQlt") + "../heart_red.3d95e6e5.png" + "?" + Date.now();
...
},{}],"gQQF6":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("hIQlt") + "../heart.2e3a595f.png" + "?" + Date.now();
...
},{}]},["8enHp","6QZzX"], "6QZzX", "parcelRequire91cc")

//# sourceMappingURL=recipe.2804e170.js.map
