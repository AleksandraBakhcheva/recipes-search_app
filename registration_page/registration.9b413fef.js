...
})({"8QyJE":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f67bb0d59b413fef";
"use strict";
...
},{}],"hakNC":[function(require,module,exports) {
...
function checkInput() {
    if (isFieldEmpty(".input1")) setErrorMessage(".surname", ".mandatory1");
    if (isFieldEmpty(".input2")) setErrorMessage(".name", ".mandatory2");
    if (isFieldEmpty(".input3")) setErrorMessage(".email", ".mandatory3");
    if (isFieldEmpty(".input4")) setErrorMessage(".password1", ".mandatory4");
    if (isFieldEmpty(".input5")) setErrorMessage(".password2", ".mandatory5");
...
function isPasswordValid() {
    if (inputPassword1.value !== inputPassword2.value) document.querySelector(".mandatory5").innerHTML = "Password does not match";
    else {
...
function isEmailUsed() {
    if (document.querySelector(".mandatory3").textContent !== "") document.querySelector(".mandatory3").textContent = "";
    users = JSON.parse(localStorage.getItem("useremails") || "[]");
    let userEmail = document.querySelector(".input3").value;
    for(let i = 0; i < users.length; i++)if (userEmail === users[i]) {
...
},{}]},["8QyJE","hakNC"], "hakNC", "parcelRequire91cc")

//# sourceMappingURL=registration.9b413fef.js.map
