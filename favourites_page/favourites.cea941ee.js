...
})({"fQe4k":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "bbd13a65cea941ee";
"use strict";
...
},{}],"eMfeQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _heartRedPng = require("../../recipe_page/img/heart_red.png");
var _heartRedPngDefault = parcelHelpers.interopDefault(_heartRedPng);
var _heartPng = require("../../recipe_page/img/heart.png");
...
function checkRegistration() {
    if (email && email != "") {
        ...
        if (arrFavorites) arrFavorites = JSON.parse(arrFavorites);
        else {
            arrFavorites = [
                {
                    email: email,
    ...
    } else document.querySelector("h2").textContent = "You need to register or sign in";
    let index = arrFavorites.findIndex((el)=>el.email === email);
    if (index > -1) array = arrFavorites[index].favRecipes.slice();
}
function renderFav(dataArr) {
    let generatedFav = "";
    result.innerHTML = "";
    for(let id = 0; id < dataArr.length; id++)generatedFav += `
...
async function getRecipes() {
    try {
        if (array.length == 0) document.querySelector("h2").textContent = "No favourites";
        else for (let id of array){
...
},{"../../recipe_page/img/heart_red.png":"9mvIB","../../recipe_page/img/heart.png":"lgm5Q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9mvIB":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("g7KjI") + "../heart_red.3d95e6e5.png" + "?" + Date.now();
...
},{}],"lgm5Q":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("g7KjI") + "../heart.2e3a595f.png" + "?" + Date.now();
...
},{}]},["fQe4k","eMfeQ"], "eMfeQ", "parcelRequire91cc")

//# sourceMappingURL=favourites.cea941ee.js.map
