...
})({"9sEq1":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "90278397274d6801";
"use strict";
...
},{}],"aMNdq":[function(require,module,exports) {
...
button.addEventListener("click", function() {
    if (formAdd.innerHTML === ``) formAdd.innerHTML = `<label for="email"><input class="login__input" type="email" placeholder="type your email" name="email" id="email"></label><label for="password"><input class="login__input password" type="password" placeholder="type your password" name="password" id="password"></label><div><button class="menu__link_button button_color" type="submit">Sign in</button></div>`;
    else formAdd.innerHTML = ``;
});
...
form.addEventListener("submit", function(event) {
    ...
    for(let i = 0; i < users.length; i++){
        if (email === users[i] && password === passwords[i]) {
            ...
            break;
        } else if (email !== users[i] || password !== passwords[i]) div.textContent = "Your email or password are not correct. Please try again...";
    }
    if (users.length === 0 || passwords.length === 0) div.textContent = "You're not registered. Please register first";
...
},{}]},["9sEq1","aMNdq"], "aMNdq", "parcelRequire91cc")

//# sourceMappingURL=index.274d6801.js.map
