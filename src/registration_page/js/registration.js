...
const INCORRECTPASSWORD =
  "The password must contain English letters, numbers, different case and one of special (!^@%=<>+#_$&*) characters. The minimum password length is 8 characters";
const QUESTION_REPLY =
  "Please use latin or cyrillic symbols, numbers or special characters. The minimum number of characters is 5";
...
function checkInput() {
  ...
  if (
    ...
    isInputValid(FIOCHECK, inputSurname) === true &&
    isInputValid(FIOCHECK, inputName) === true &&
    isInputValid(EMAILCHECK, inputEmail) === true &&
    isInputValid(PASSWORDCHECK, inputPassword1) === true &&
    isInputValid(PASSWORDCHECK, inputPassword2) === true &&
    isEmailUsed() === false
  ) {
